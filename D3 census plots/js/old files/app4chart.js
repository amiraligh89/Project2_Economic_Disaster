...
var yr2017 = d3.csv("/data/census_data2017_state.csv")
var yr2016 = d3.csv("/data/census_data2016_state.csv")
var yr2015 = d3.csv("/data/census_data2015_state.csv")
var yr2014 = d3.csv("/data/census_data2014_state.csv")
var yr2013 = d3.csv("/data/census_data2013_state.csv")

// See http://jsfiddle.net/spanndemic/5JRMt/ for drop down box
function updateLegend(yearValue) {

    // bind data
    var appending = chart.selectAll('rect')
        .data(yearValue);
...
d3.select("#year").on('change', function() {
    var yearValue = eval(d3.select(this).property('value'));
    console.log(yearValue)
    updateLegend(yearValue);
    ...
    //     console.log(censusData)
        ...
        var highschoolLabel = yLabelsGroup.append("text")
            .classed("aText", true)
            .classed("active", true)
            .attr("x", 0)
            .attr("y", 0 - 25)
        ...
        var collegeLabel = yLabelsGroup.append("text")
            .classed("aText", true)
            .classed("inactive", true)
            .attr("x", 0)
            .attr("y", 0 - 50)
        ...
        var rentalLabel = yLabelsGroup.append("text")
            .classed("aText", true)
            .classed("inactive", true)
            .attr("x", 0)
            .attr("y", 0 - 75)
            ...
            var mortgageLabel = yLabelsGroup.append("text")
            .classed("aText", true)
            .classed("inactive", true)
            .attr("x", 0)
            .attr("y", 0 - 100)
